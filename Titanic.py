...
#finding relation between features and survival
...
# low Pclass have better average survival than the high Pclass this can be clearly understood from the plot below.
